...
const POLITICIAN_KEYWORDS: Record<string, string[]> = {
  ...
  "pushpa-kamal-dahal": ["पुष्पकमल दाहाल", "पुष्प कमल दहाल", "Pushpa Kamal Dahal", "Prachanda"],
  "kp-sharma-oli": ["केपी शर्मा ओली", "के.पि. शर्मा ओली", "KP Oli", "KP Sharma Oli"],
  "sher-bahadur-deuba": ["शेरबहादुर देउवा", "शेर बहादुर देउवा", "Sher Bahadur Deuba", "Deuba"],
  "gagan-thapa": ["गगन थापा", "Gagan Thapa"],
  "rajendra-lingden": ["राजेन्द्र लिङदेन", "राजेन्द्र लिङ्देन", "Rajendra Lingden", "Lingden"],
  ...
  "ram-chandra-poudel": ["राम चन्द्र पोख्रेल", "Ram Chandra Poudel"],
  "kirti-agni-shakya": ["कीर्ति अग्नि शाक्य", "Kirti Agni Shakya"],
  "suskant-mandal": ["सुशील कुमार मण्डल", "Susilkumar Mandal"],
  "ghanasyal-ruvial": ["घनश्याम रुदवाल", "Ghanashyam Rudwal"],
  "arjun-narasingha-kc": ["अर्जुन नरसिंह के.च.", "Arjun Narasingha KC"],
  "niranjan-sharma": ["निरञ्जन शर्मा", "Niranjan Sharma"],
  "hembahadur-malla": ["हेम बहादुर मल्ल", "Hem Bahadur Malla"],
  "shailendra-kumar": ["शैलेंद्र कुमार", "Shailendra Kumar"],
  "candra-kant-rawat": ["चन्द्रकान्त राउत", "Chandra Kant Raut"],
  "gopal-kiran": ["गोपाल किरान", "Gopal Kiran"],
  "sujan-chauhan": ["सुजन चौहान", "Sujan Chauhan"],
  "manish-kumar": ["मनिश कुमार", "Manish Kumar"],
  "ramesh-chandan": ["रमेश चन्दन", "Ramesh Chandan"],
  "sanya-kumar": ["संया कुमार", "Sanya Kumar"],
};
